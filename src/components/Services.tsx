...
const services = [
  {
    ...
    title: 'Polimento',
    description:
      'Remoção de riscos, hologramas e oxidação. Restaure a verdadeira profundidade e acabamento espelhado da pintura.'
  },
  {
    icon: Car,
    title: 'Detalhamento',
    description:
      'Cuidado completo e minucioso para cada detalhe do seu veículo. Perfeição interna e externa.'
  },
  {
    icon: Droplets,
    title: 'Lavagem',
    description:
      'Lavagem profissional com produtos premium. Seu carro limpo e protegido com técnicas especializadas.'
  },
  {
    icon: Wrench,
    title: 'Limpeza',
    description:
      'Limpeza profunda de interior e exterior. Eliminação de sujeira, odores e manchas difíceis.'
  },
  {
    icon: Hammer,
    title: 'Martelinho de Ouro',
    description:
      'Remoção de amassados sem pintura. Técnica especializada que preserva a originalidade da lataria.'
  },
  {
    icon: SprayCan,
    title: 'Higienização',
    description:
      'Limpeza profunda do interior com técnicas especializadas, eliminando sujeiras, bactérias e odores para mais conforto e bem-estar.'
  }
];
