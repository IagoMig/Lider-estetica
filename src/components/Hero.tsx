    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-black text-white py-20">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Detalhamento de Carro de Luxo"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-10rem)]">
          ...
          >
            ...
            <p className="text-gray-300 text-lg md:text-xl max-w-xl mb-8 font-medium leading-relaxed">
              Se você está procurando lava car em Curitiba, a Líder Estética Automotiva é a escolha certa.
              Somos especialistas em estética automotiva profissional, oferecendo serviços completos para
              limpeza, proteção e valorização do seu veículo.
            </p>

            {/* Localização com links */}
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  <a
                    ...
                    className="font-semibold hover:text-[#39FF14] transition-colors"
                  >
                    Unidade Uberaba:
                  </a>
                  <br />
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onBlur={() => setFocusedField(null)}
                  placeholder="Conte-nos sobre seu veículo..."
                />
              </div>
